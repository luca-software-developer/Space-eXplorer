    ...
    <header id="cover">
        ...
        ?>
            <form class="sign-up" method="post" action="login.php">
                <input type="email" id="email" name="signup-email" value="<?php echo $_SESSION['signup-email'] ?? ''; ?>" placeholder="Inserisci qui la tua e-mail" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="150" autocomplete="off" required />
